...
class Emprestimos extends StatefulWidget {
  const Emprestimos({Key? key}) : super(key: key);

  @override
  _Emprestimos createState() => _Emprestimos();
}
// class API {
//   postAPI() async {
//     const String url =
...
API_post() async {
  String url =
      'https://financas-app-d4cef-default-rtdb.firebaseio.com/Usuarios/Brenda/Despesas/Emprestimos.json';
...
API_delete(id_banco) async{
    String url =
      'https://financas-app-d4cef-default-rtdb.firebaseio.com/Usuarios/Brenda/Despesas/Emprestimos/$id_banco.json';
...
TextEditingController vencimentoInput = TextEditingController();
...
TextEditingController vencimentoInput_edicao = TextEditingController();
...
class _Emprestimos extends State<Emprestimos> {
  //var isPressed = false;
